...
info.onCountdownEnd(function () {
    game.showLongText("AHAHAHAHAHAHHAHA", DialogLayout.Bottom)
    info.startCountdown(10)
    info.changeLifeBy(5)
    for (let index = 0; index < 70; index++) {
        projectile = sprites.createProjectileFromSide(asteroids[randint(0, asteroids.length - 1)], 20, 75)
        projectile.setKind(SpriteKind.Enemy)
        projectile.x = randint(10, scene.screenWidth())
        projectile.follow(ship)
...
asteroids = [img`
    ...
    . . 9 9 9 9 9 f 9 9 f f f . . . 
    . . f 9 f 9 f 9 f 9 f 9 f . . . 
    . . f f f 9 9 9 f 9 f 9 f . . . 
    . . f 9 f 9 9 f 9 9 f 9 f . . . 
    . . 9 9 9 9 f 9 9 9 f 9 f . . . 
    . . 9 9 9 9 f f f 9 f f f . . . 
    . . 9 9 9 9 9 9 9 9 9 9 9 . . . 
    . . 9 9 9 9 9 9 9 9 9 9 9 . . . 
    . . 9 9 9 9 9 9 9 9 9 9 9 . . . 
    . . 9 9 9 9 9 9 9 9 9 9 9 . . . 
